...
function isTestFile(filePath: string): boolean
{
    ...
    const hasTestSuffix = filePath.endsWith('.test.js') || filePath.endsWith('.spec.js') || filePath.endsWith('.test.ts') || filePath.endsWith('.spec.ts') || filePath.endsWith('.test.jsx') || filePath.endsWith('.spec.jsx') || filePath.endsWith('.test.tsx') || filePath.endsWith('.spec.tsx') || filePath.endsWith('test.js')
